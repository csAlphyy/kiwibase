...
class CCSWeaponData;
typedef CCSWeaponData weapondata_t;
class weapon_t : public entity_t
{
public:
    netvar_fn( int, id, "DT_BaseAttributableItem", "m_iItemDefinitionIndex" );
    netvar_fn( bool, not_reloading, "DT_WeaponCSBase", "m_bReloadVisuallyComplete" );
    ...
    netvar_fn( float, cock_amount, "DT_WeaponCSBase", "m_flPostponeFireReadyTime" );
    netvar_fn( float, accuracy_penalty, "DT_WeaponCSBase", "m_fAccuracyPenalty" );

    weapondata_t* weapon_data( void );
    float spread( void );
    float inaccuracy( void );
    void update( void );
